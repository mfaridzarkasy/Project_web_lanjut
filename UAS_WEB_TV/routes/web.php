...
// Dashboard
Route::get('/', [TelevisiController::class, 'index']);
...
// CRUD Movie
Route::get('/televisis/data', [TelevisiController::class, 'data'])->middleware('auth');
// Memerlukan otentikasi untuk membaca data film.

Route::get('/televisis/create', [TelevisiController::class, 'create'])->middleware('auth');
// Memerlukan otentikasi untuk menampilkan halaman pembuatan film.

Route::post('/televisi/store', [TelevisiController::class, 'store'])->middleware('auth');
// Memerlukan otentikasi untuk menyimpan data film baru.

Route::get('/televisi/{id}/edit', [TelevisiController::class, 'edit'])->middleware('auth');
// Memerlukan otentikasi untuk menampilkan halaman pengeditan film berdasarkan ID.

Route::post('/televisi/{id}/edit', [TelevisiController::class, 'update'])->middleware('auth');
// Memerlukan otentikasi untuk menyimpan perubahan pada data film berdasarkan ID.

Route::get('/televisi/delete/{id}', [TelevisiController::class, 'delete'])->middleware('auth');
